...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      const webR46 = {
        repositoryUrl: new URL("/docs/package-repos/webr", location.origin).href,
        binaryRVersion: "4.6",
        packageIndexUrls: [new URL("/docs/package-repos/webr/bin/emscripten/contrib/4.6/PACKAGES", location.origin).href]
      };
