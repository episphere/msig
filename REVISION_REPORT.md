...
| C7 Cross-platform runs | PARTIAL | `docs/manuscript/experiments/cross_platform_runs/macos/`. macOS smoke tests passed in Chrome, Firefox, and Playwright WebKit; Linux and the shipping Safari application remain untested. |
...
- The macOS evidence is limited to Chrome, Firefox, and Playwright WebKit smoke tests plus three benchmark repeats; Linux and the shipping Safari application remain untested.
